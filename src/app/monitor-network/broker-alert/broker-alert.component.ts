...
@Component({
  ...
  templateUrl: './broker-alert.component.html',
  styleUrls: ['./broker-alert.component.scss']
})

export class BrokerAlertComponent implements OnInit {
  ...
  fetchChangeAlertBroker(resetData: boolean = false): void {
  ...
  const apiKey = AppSettings.APIsNameArray.CHANGEALTERT.BROKER 
  ...
  applyFilters() {
    ...
    this.fetchChangeAlertBroker(true);
  }
  clearForm() {

...
export class RecentProfileViewsComponent implements OnInit {
  ...
  getSaveCarrierList() {
    ...
    let APIparams = {
      apiKey: AppSettings.APIsNameArray.SAVECARRIRLIST.RECENTVIEWS,
      uri: uri,
    };
  ...
  getAPIParam() {
    ...
    let url;
    url = AppSettings.APIsNameArray.SAVECARRIRLIST.RECENTVIEWS;
    APIparams = {
      apiKey: url,

...
export class BrokerProfile implements OnInit {
  ...
  profileUpdate({ value, valid }) {
    if (valid) {
      this.loading = true;
      let APIparams = {
        apiKey: AppSettings.APIsNameArray.USER.BROKERUPDATE,
        uri: '',
        postBody: value,
      };
  ...
  getFormattedAddress(address1: any,address2:any, city:any, countryCode:any, stateCode:any, zipShort:any): string {
